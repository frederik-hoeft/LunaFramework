...
namespace LunaForms
{
    public class LunaAnimatedButton : Button
    {
        ...
        private Font FontT = new Font("Segoe UI", 12F);
        ...
        public override string Text
        {
            ...
            {
                base.Text = value;
                _textSize = CreateGraphics().MeasureString(uppercase ? value.ToUpper() : value, FontT);
                if (AutoSize)
                    Size = GetPreferredSize();
                Invalidate();
            }
